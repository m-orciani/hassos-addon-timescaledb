...
# Builds all dependencies or a specific one, an pushes it to the registry 
    ...
    if [ -z "$2" ]; then
        ...
        build_dependency timescaledb-toolkit-pg16 "1.21.0"
        build_dependency timescaledb-toolkit-pg17 "1.21.0"
        build_dependency postgis-pg16 "3.6.0"
        build_dependency postgis-pg17 "3.6.0"
